                    ...
                    <div class=" form-grids form-grids-right">
                        <div class="widget-shadow " data-example-id="basic-forms">
                            <div class="form-title">
                                <h4 class="text-center">Add Mark Information:</h4>
                            </div>
                            <div class="form-body">
                                <form class="form-horizontal" method="POST" action="{!! route('mark.edit',$mark->id) !!}" enctype="multipart/form-data" id="">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Mark Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="m_name" class="form-control" id="name" value="{{$mark->m_name}}" required>
                                        </div>
                                        <div class="col-sm-9">
